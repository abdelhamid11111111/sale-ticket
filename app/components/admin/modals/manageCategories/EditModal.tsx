...
const EditModal = ({ UpdateState, Name, Id }: AddCategoryProp) => {
  ...
  return (
    <div>
      <button
        onClick={handleModal}
        className="p-2 text-[#135bec] text-3xl rounded-lg hover:bg-gray-100 transition-colors"
      >
